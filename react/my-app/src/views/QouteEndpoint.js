            ...
            <div>
                <div className="container my-5">
                    <div className="row">
                        ...
                        { <GlobalQoute match={this.props.match.params.sym} /> }
                        {/* { <GlobalQoute match={this.props.match.params.sym} key={g.symbol} GlobalQoute={g} symbol={g.symbol} opens={g.opens} high={g.high} low={g.low} price={g.price} volume={g.volume}
                        ...
                        { <Chart match={this.props.match.params.sym} /> }
                    </div>
                </div>
            </div>
        )
